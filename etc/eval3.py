...
'''Define CLIP model version, CLIP feature dimension, device, model.
Available CLIP model versions: 
["RN50", "RN101", "RN50x4", "RN50x16", "RN50x64", "ViT-B/32", "ViT-B/16", "ViT-L/14"] {type:"string"}
...
hier_txt_path = '/home/ubuntu/RebuilderAI/Rendering-Recommendation-API/categories_semantic_hierarchy.txt'
